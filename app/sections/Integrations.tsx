    ...
    <section className="py-24 overflow-hidden" id="integrations">
      <div className="container">
        <div className="grid xl:grid-cols-2 items-center xl:gap-16">
          ...
          <div className="h-[400px] xl:h-[800px] mt-8 xl:mt-0 overflow-hidden grid md:grid-cols-2 gap-4 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
