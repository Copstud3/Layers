...
export default function Navbar() {
  ...
  return (
    <>
      <section className="mt-4 xl:py-8 fixed xl:w-full top-0 z-50 w-[100%] -ml-4">
        <div className="xl:max-w-5xl md:max-w-3xl mx-auto ">
          <div className="border border-white/15 rounded-[27px] md:rounded-full bg-neutral-950/70 backdrop-blur ">
            <div className="grid grid-cols-2 xl:grid-cols-3 py-2 px-5 justify-center md:pr-2 items-center">
              <div>
                <Link href="/">
                  <Image
                    src={logoImage}
                  ...
                  <div className="flex flex-col items-center justify-evenly py-4 h-[500px] -mt-10">
                    {navLinks.map((link) => (
                      <a
                        href={link.href}
                        key={link.label}
                        className="text-center hover:text-white/30"
                      >
                        {link.label}
      ...
      <div className="pb-[86px] md:pb-[98px] xl:pb-[130px]"></div>
    </>
  );
}
